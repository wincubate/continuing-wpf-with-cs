...
using Wincubate.MvvmPatternsExamples.Slide09.Models;
using Wincubate.MvvmPatternsExamples.Slide09.Services;
using Wincubate.MvvmPatternsExamples.Slide09.ViewModels.Messages;

namespace Wincubate.MvvmPatternsExamples.Slide09.ViewModels
{
    public class ParticipantDetailViewModel : GalaSoft.MvvmLight.ViewModelBase
    {
        ...
        {
            IDialogService dialog = SimpleIoc.Default.GetInstance<IDialogService>();
            if (dialog.Prompt("Are you sure?", "Save Participant?"))
            {
